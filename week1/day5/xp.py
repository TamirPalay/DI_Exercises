...
for member, age in family.items():
    if age < 3:
        ...
        cost = 15
    print(f"{member.capitalize()} (age {age}): ${cost}")
    total_cost += cost
...
char_to_index_sorted = {char: index for index, char in enumerate(sorted_chars)}
print("Character to Index:", char_to_index)
print("Index to Character:", index_to_char) 
print("Sorted Character to Index:", char_to_index_sorted)